...
{
	this.mainNode = node
	if (!this.mainNode.Scroller)
		this.mainNode.Scroller = this
	...
	Programica.Scroller.active = this
}
...
(
	...
	function (e)
	{
		if (!Programica.Scroller.active) return
		
		if (e.ctrlKey)
			switch (e.keyCode)
			{
				case 37:
					Programica.Scroller.active.goPrev()
					break
				case 39:
					Programica.Scroller.active.goNext()
					break
			}
	},
	true
